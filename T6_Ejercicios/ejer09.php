        ...
        <article>
          ...
          <?php
            ...
            if (isset($_COOKIE['productos'])) {
              //deserializo el array, decodificándolo en base 64
              ...
              //serializo el array para introducirlo en la cookie 
              //en base 64 para que se quede bien y pueda recuperarlo también en base 64
              setcookie("productos", (serialize($productos)), time() + 3*24*3600);
            } 
          ?> 
            <form id='formIntro' action='ejer09_ABM.php' method='post'>
              <input type='submit' value='GESTIÓN DE PRODUCTOS'>
            </form>
            ...
            <article id="productos">
              <h3>Productos</h3>
          <?php
                foreach ($productos as $codigoProducto => $cadaProducto) {
                  ...
                  echo "</div>";
          ?>
                  <form class="float" action="ejer09.php" method="post">
                    <input type="submit" name="peticion" value="Comprar">
                    <input type="hidden" name="codigo" value="<?=$codigoProducto?>">
                  </form>
          <?php
                  echo "</section>";
                }
          ...
          <?php
                ...
                $total = 0;
                foreach ($productos as $codigoProducto => $productoSolo) {
